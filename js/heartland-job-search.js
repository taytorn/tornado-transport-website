// Updated job search script to use Heartland-only jobs database
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (searchForm) {
        searchForm.addEventListener('submit', function(e) {
            ...
            // Fetch jobs data from the Heartland-only jobs database
            fetch('data/heartland_jobs_updated.json')
                .then(response => response.json())
                .then(data => {
                    // Find matching jobs
                    const matchingJobs = findMatchingJobs(data.jobs, zipCode, jobType, experience);
    ...
    function displayJobs(jobs, zipCode) {
        ...
        let eligibilityHtml = `
            <div class="alert alert-info mb-4">
                ...
                Based on your ZIP code, you are eligible for the following driving positions. All positions require 12+ months of verifiable trucking experience.
            </div>
        `;
